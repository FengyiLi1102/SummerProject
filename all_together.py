...
def model_train_set(train, test, params, model_type, fold_n):
    ...
    for i in types:
        ...
        test_plus_copy = test_plus_copy.set_index('id')
...
train = pd.read_csv(r'G:\train_d2.csv')
test = pd.read_csv(r'G:\test_d2.csv')
test_original = pd.read_csv(r'\\icnas4.cc.ic.ac.uk\fl4718\Desktop\Machine learning\Data\test.csv')
submission = pd.read_csv(r'\\icnas4.cc.ic.ac.uk\fl4718\Desktop\Machine learning\Data\sample_submission.csv')
